...
//   const [countdown, setCountdown] = useState(0);
//   const [crashPoint, setCrashPoint] = useState(1);
//   const [, setCurrentMultiplier] = useState("1.00");
//   const multiplierRef = useRef<number>(1); // Set initial multiplier to 1
//   const startTime = useRef(Date.now());
//   const socket = useRef<ReturnType<typeof io> | null>(null);
//   const gameInterval = useRef<NodeJS.Timeout | null>(null);
//   const [, setIsBetting] = useState(false);
...
//     setTimePoints((prev) => [...prev, elapsed]);
//     setDataPoints((prev) => [...prev, multiplierRef.current]);
//     setCurrentMultiplier(parseFloat(multiplierRef.current.toFixed(2)).toString());
//   }, []);
...
//         0%   { background-position: 100% 0; background-color: #044717; }
//         100% { background-position: 0% 0; background-color: #1f1e1e; }
//       }
//     `;
...
//         // Reset data points based on the new multiplier
//         setDataPoints([multiplierRef.current]);
//         setTimePoints([0]);
//         setCurrentMultiplier(multiplierRef.current.toFixed(2));
